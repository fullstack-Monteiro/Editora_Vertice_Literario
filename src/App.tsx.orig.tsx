...
const App = () => {
  ...
  const [formData, setFormData] = React.useState({ nome: '', email: '', servico: 'Edi├º├úo e Publica├º├úo', mensagem: '' });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setFormData({ nome: '', email: '', servico: 'Edi├º├úo e Publica├º├úo', mensagem: '' });
      } else {
        setFormStatus('error');
      }
    } catch {
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-5 md:px-12 w-full py-32 md:py-0">
          ...
          >
            <h1 className="text-3xl sm:text-5xl md:text-7xl font-serif font-bold text-white mb-6 leading-tight">
              {siteContent?.hero?.titulo ? siteContent.hero.titulo.replace('florescer.', '') : 'A palavra ├⌐ a semente, a nossa miss├úo ├⌐ faz├¬-la '}<span className="text-primary-blue">florescer.</span>
            </h1>
            <p className="text-base sm:text-xl text-slate-300 mb-8 leading-relaxed font-light">
              {siteContent?.hero?.subtitulo ?? 'Apoiamos autores e transformamos palavras em obras publicadas com excel├¬ncia, ├⌐tica e sofistica├º├úo cultural.'}
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
            <div className="max-w-2xl">
              <span className="text-gold font-bold tracking-widest text-xs mb-4 block">CAT├üLOGO SELECIONADO</span>
              <h2 className="text-2xl sm:text-4xl font-serif font-bold text-navy leading-tight">Obras Publicadas e Dispon├¡veis para Aquisi├º├úo</h2>
            </div>
          </div>
      ...
      <section id="sobre" className="bg-slate-50 py-16 md:py-24 px-5 md:px-12 overflow-hidden">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <span className="text-gold font-bold tracking-widest text-xs mb-4 block">HIST├ôRICO INSTITUCIONAL</span>
            <h2 className="text-2xl sm:text-4xl font-serif font-bold text-navy mb-6 leading-tight">Uma Institui├º├úo Mo├ºambicana Dedicada ├á Excel├¬ncia Liter├íria</h2>
            <div className="space-y-5 text-slate-600 leading-relaxed">
              <p>
                {siteContent?.sobre?.texto ?? 'A Editora V├⌐rtice Liter├írio, Lda. ├⌐ uma institui├º├úo mo├ºambicana dedicada ├á promo├º├úo e ao desenvolvimento da literatura no pa├¡s e no espa├ºo lus├│fono.'}
              </p>              <button
            ...
            <div className="grid grid-cols-2 gap-8 mt-12">
              <div>
                <h4 className="font-serif font-bold text-navy mb-3 text-lg border-l-4 border-gold pl-4">Miss├úo</h4>
                <p className="text-sm text-slate-500">{siteContent?.sobre?.missao ?? 'Apoiar autores emergentes e consolidados, publicar obras de impacto liter├írio, social e cultural.'}</p>
              </div>
              <div>
                <h4 className="font-serif font-bold text-navy mb-3 text-lg border-l-4 border-gold pl-4">Vis├úo</h4>
                <p className="text-sm text-slate-500">{siteContent?.sobre?.visao ?? 'Ser uma das editoras de refer├¬ncia em Mo├ºambique e no espa├ºo lus├│fono.'}</p>
              </div>
            </div>
          </motion.div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 md:mb-16">
            ...
            <p className="text-slate-400 max-w-3xl mx-auto leading-relaxed">
              A Editora V├⌐rtice Liter├írio orienta-se por uma filosofia que privilegia a coopera├º├úo, a inclus├úo e a promo├º├úo equitativa das express├╡es liter├írias mo├ºambicanas e lus├│fonas. A nossa actua├º├úo editorial pauta-se pela convic├º├úo de que a literatura constitui um patrim├│nio colectivo e que o ambiente cultural se robustece quando as institui├º├╡es trabalham em converg├¬ncia, e n├úo em oposi├º├úo. N├úo integramos o mercado editorial com o prop├│sito de competir, rivalizar ou disputar protagonismos. A nossa presen├ºa assenta na defesa de um ecossistema liter├írio plural, democr├ítico e aberto, onde diversas editoras, autores, iniciativas e sensibilidades possam coexistir e florescer em benef├¡cio da cultura nacional.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-slate-50 py-16 md:py-24 px-5 md:px-12">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-500 text-sm max-w-xl mx-auto">A estrutura organizacional assegura qualidade, coordena├º├úo e efici├¬ncia nas opera├º├╡es.</p>
          </div>

          {/* Direc├º├úo + Admin */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto mb-12">
            {[
              { name: "Bonif├ício B. Fabi├úo", role: "Diretor Executivo", desc: "Respons├ível pela orienta├º├úo estrat├⌐gica, representa├º├úo institucional e supervis├úo global das actividades editoriais, administrativas e culturais." },
              { name: "Egas M. Mepuanda", role: "Administrador", desc: "Executam tarefas de gest├úo interna, documenta├º├úo, comunica├º├úo e articula├º├úo com autores, estagi├írios e parceiros culturais." },
            ].map((member, index) => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto mb-16">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
              ...
              <p className="text-xs text-gold font-bold tracking-widest uppercase mb-4">Chingodzi ΓÇô Paragem Juventude</p>
              <p className="text-slate-500 text-sm mb-4">N├║cleo t├⌐cnico da editora. As fun├º├╡es incluem:</p>
              <ul className="space-y-1">
                {["Acompanhamento a autores", "Revis├úo e edi├º├úo", "Prepara├º├úo estrutural de obras", "Apoio presencial e remoto", "Gest├úo de projectos editoriais"].map((item, i) => (
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} viewport={{ once: true }}
              ...
              <p className="text-slate-500 text-sm mb-4">Respons├ível pela componente visual das obras e identidade institucional, incluindo:</p>
              <ul className="space-y-1">
                {["Cria├º├úo de capas", "Diagrama├º├úo profissional", "Produ├º├úo de materiais gr├íficos", "Constru├º├úo da identidade visual da editora"].map((item, i) => (
                  <li key={i} className="flex items-center gap-2 text-sm text-slate-600">
                    <span className="w-1.5 h-1.5 bg-gold rounded-full shrink-0"></span>{item}
                  </li>
                ))}
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
              {["Sheila Khan", "Solene Santos Almo├ºo", "Samila Sim├╡es Manuel Ant├│nio", "Stephen Pinto"].map((name, index) => (
            ...
            <div className="bg-white p-8 shadow-sm border border-slate-100">
              <p className="text-xs font-bold tracking-widest text-gold uppercase mb-4">├üreas de Contribui├º├úo</p>
              <ul className="grid grid-cols-1 md:grid-cols-2 gap-2">
                {["Apoio na revis├úo e prepara├º├úo textual", "Organiza├º├úo t├⌐cnica de conte├║dos", "Assist├¬ncia administrativa", "Recolha e pesquisa de informa├º├úo", "Colabora├º├úo em processos editoriais", "Maquetiza├º├úo e diagrama├º├úo"].map((item, i) => (
      ...
      <section id="servicos" className="bg-navy py-16 md:py-24 px-5 md:px-12 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-20">
            <span className="text-gold font-bold tracking-widest text-xs mb-4 block">SOLU├ç├òES EDITORIAIS</span>
            <h2 className="text-2xl sm:text-4xl md:text-5xl font-serif font-bold text-white mb-6">├üreas de Actua├º├úo e Servi├ºos</h2>
            <p className="text-slate-400 max-w-2xl mx-auto">Oferecemos um ecossistema completo para que a sua obra alcance o patamar de excel├¬ncia que o mercado liter├írio exige.</p>
          </div>
          ...
          <div className="mt-16 text-center">
            ...
            >
              SOLICITAR SERVI├çO <ArrowRight size={18} />
            </motion.a>
            <motion.button
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 md:mb-16 gap-4">
            <div className="max-w-2xl">
              ...
              <h2 className="text-2xl sm:text-4xl font-serif font-bold text-navy leading-tight">Blog V├⌐rtice Liter├írio</h2>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
            ...
            >
              ...
              <h2 className="text-2xl sm:text-4xl font-serif font-bold text-navy mb-6 leading-tight">Vamos Dar Vida ├á Sua Obra Liter├íria</h2>
              <p className="text-slate-600 mb-12 leading-relaxed">
                Estamos prontos para ouvir a sua hist├│ria e transform├í-la num livro de excel├¬ncia. Entre em contacto connosco para or├ºamentos ou consultoria.
              </p>
              ...
              <div className="space-y-8">
                ...
                <div className="flex gap-6">
                  ...
                  <div>
                    <h4 className="font-serif font-bold text-navy text-lg mb-1">Localiza├º├úo</h4>
                    <p className="text-slate-500">Cidade de Tete, Paragem Juventude, junto ao Mercado Cambinde. Estrada Nacional n┬║ 7, Mo├ºambique.</p>
                  </div>
                </div>
              </div>
            </motion.div>
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input type="text" required value={formData.nome} onChange={e => setFormData({...formData, nome: e.target.value})} className="w-full bg-slate-50 border-b border-slate-200 p-4 focus:border-gold outline-none transition-colors" placeholder="Ex: Jo├úo Silva" />
                  </div>
                  <div className="space-y-2">
                ...
                <div className="space-y-2">
                  <label className="text-[10px] font-bold tracking-widest text-slate-400 uppercase">Servi├ºo de Interesse</label>
                  <select value={formData.servico} onChange={e => setFormData({...formData, servico: e.target.value})} className="w-full bg-slate-50 border-b border-slate-200 p-4 focus:border-gold outline-none transition-colors appearance-none">
                    <option>Edi├º├úo e Publica├º├úo</option>
                    <option>Revis├úo Textual</option>
