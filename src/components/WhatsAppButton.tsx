  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
          ...
          >
            ...
            <div className="bg-[#25D366] px-5 py-4 flex items-center gap-3">
              ...
              <div className="flex-1">
                <p className="text-white font-bold text-sm">Vértice Literário</p>
            ...
            {/* Message bubble */}
            <div className="px-5 py-5 bg-[#f0f0f0]">
              <div className="bg-white rounded-xl rounded-tl-none px-4 py-3 shadow-sm max-w-[85%]">
                <p className="text-slate-700 text-sm leading-relaxed">
                  Olá! 👋 Como podemos ajudar? Fale connosco sobre publicação, revisão ou qualquer serviço editorial.
                </p>
                <span className="text-[10px] text-slate-400 mt-1 block text-right">agora</span>
              </div>
            </div>
            ...
            <div className="px-5 py-4 bg-white">
              <a
                ...
                className="w-full bg-[#25D366] hover:bg-[#1ebe5d] text-white font-bold text-sm py-3 rounded-xl flex items-center justify-center gap-2 transition-colors duration-200"
              >
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        className="relative bg-[#25D366] text-white w-14 h-14 rounded-full shadow-2xl flex items-center justify-center"
